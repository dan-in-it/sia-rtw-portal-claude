            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Escalations</dt>
                      <dd className="text-lg font-semibold text-gray-900">{stats.totalEscalations}</dd>
                    </dl>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500">Add, edit, and manage users</p>
                </div>
                <div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900">Chatbot Training</p>
                  <p className="text-sm text-gray-500">Manage training documents</p>
                </div>
                <div>
                  <svg className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900">Categories & Tags</p>
                  <p className="text-sm text-gray-500">Manage forum categories</p>
                </div>
                <div>
                  <svg className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
